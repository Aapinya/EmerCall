...
import aom.snru.ac.th.emercall.utility.HopitalAdapter;
...
//        Create LisView
        ...
        int[]ints = new  int[]{R.drawable.station1,R.drawable.station2,};
                               R.drawable.station3,R.drawable.sstation4,R.drawable.station1,
                               R.drawable.station2,R.drawable.station3,R.drawable.sstation4};
        ...
        String[]phoneStrings = new String[]{"1111","1112","1113","1114","1115", "1116",
                "1117","1118"};
        HopitalAdapter hospitalAdapter = new HopitalAdapter(getActivity(), ints,   )
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fiagment_hospital, container, false);
        return view;
    }
